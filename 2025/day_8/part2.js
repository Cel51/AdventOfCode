...
var lastFromCircuit = null;
var lastToCircuit = null;
...
allDistances.forEach((distance) => {
    ...
    if (fromCircuitIndex !== toCircuitIndex) {
        lastFromCircuit = distance.from;
        lastToCircuit = distance.to;
...
console.log(parseInt(lastFromCircuit.split(',')[0]) * parseInt(lastToCircuit.split(',')[0]));